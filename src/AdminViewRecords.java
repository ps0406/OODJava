...
public class AdminViewRecords extends javax.swing.JFrame {
    ...
    public AdminViewRecords() {
        ...
        String a;
        try(BufferedReader reader = new BufferedReader (new FileReader("AdminAccount.txt")))
        {
                        ...
                        while (readItem.hasNextLine())
                        {
                            ...
                            TransactionList.add(item);
                                ...
                                String[] showItem = {String.valueOf(item.ItemID), item.ItemTitle, item.ItemDescription, String.valueOf(item.ItemPrice), item.DMethod
                                                     ,item.Seller,item.Buyer, String.valueOf(item.SuccessFee)};
    ...
    private void initComponents() {
        ...
        ItemTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item ID", "Item Title", "Item Description", "Price (RM)", "Method of Delivery", "Seller", "Buyer", "Success Fee"
            }
        ) {
