...
public class SellerViewRecords extends javax.swing.JFrame {

    ArrayList<Item> TransactionList = new ArrayList<>();
    String Email;
    
    
    public SellerViewRecords() {
        initComponents();
                        ...
                        while (readItem.hasNextLine())
                        {
                            ...
                            if (item.Seller.equals(Email))
                            {
                                String[] showItem = {String.valueOf(item.ItemID), item.ItemTitle, item.ItemDescription, String.valueOf(item.ItemPrice), item.DMethod
                                                     ,item.Buyer, String.valueOf(item.SuccessFee)};
    ...
    private void initComponents() {
        ...
        ItemTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item ID", "Item Title", "Item Description", "Price (RM)", "Method of Delivery", "Buyer", "Success Fee"
            }
        ) {
